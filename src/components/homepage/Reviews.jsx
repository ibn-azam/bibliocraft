...
const reviews = [
  {
    ...
    rating: 5,
    quote:
      "Absolutely spellbinding. I finished it in one sitting and immediately wished I could read it again for the first time.",
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "Every page drips with atmosphere. A rare book that makes you feel like you are living inside the story.",
    bookTitle: "Piranesi",
    bookGenre: "Fantasy",
  },
  {
    ...
    rating: 4,
    quote:
      "Beautifully written with characters so real they linger long after the final chapter.",
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "A masterclass in suspense. I was holding my breath through the last 100 pages.",
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "Profound and deeply moving. Changed how I see the world — not many books can claim that.",
    bookTitle: "Educated",
    bookGenre: "Memoir",
  },
  {
    ...
    rating: 4,
    quote:
      "Wildly imaginative. The world-building is unlike anything I have encountered in modern fiction.",
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(270deg, #0f0c07, transparent)",
          }}
        />
