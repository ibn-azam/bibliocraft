      ...
      >
        ...
        <motion.div variants={fadeUp(0.1)} className="text-center mb-8 space-y-3">
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#9a8a6a" }}>
            Join your digital library and start reading today.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-medium" style={{ color: "#6b5e45" }}>or sign up with email</span>
            <div className="flex-1 h-px" style={{ background: "rgba(232,213,163,0.12)" }} />
          </div>
          ...
          <form onSubmit={handleSubmit(handleSignupFunc)} className="space-y-4">
            ...
            {/* Full Name */}
            <div>
              <label htmlFor="name" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: "#9a8a6a", fontFamily: "Georgia, serif" }}>
                Full Name
              </label>
              <input
                id="name"
            ...
            {/* Photo URL */}
            <div>
              <label htmlFor="photo" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: "#9a8a6a", fontFamily: "Georgia, serif" }}>
                Photo URL
              </label>
              <input
                id="photo"
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm outline-none transition-all"
                style={inputStyle(errors.photo)}
                onFocus={(e) => onFocus(e, errors.photo)}
                onBlur={(e) => onBlur(e, errors.photo)}
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: "#9a8a6a", fontFamily: "Georgia, serif" }}>
                Email
              </label>
              <input
                id="email"
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: "#9a8a6a", fontFamily: "Georgia, serif" }}>
                Password
              </label>
              <input
                id="password"
        ...
        >
          ...
          <Link href="/login" className="font-semibold" style={{ color: "#e8d5a3", fontFamily: "Georgia, serif" }}>
            Log in
          </Link>
        </motion.p>
      </motion.div>
