...
const SignUpPage = () => {
    ...
    const getStrength = (pw) => {
        ...
        if (pw.length < 10) return { level: 2, label: 'Fair',   color: '#fb923c' };
        if (/[A-Z]/.test(pw) && /[0-9]/.test(pw) && /[^a-zA-Z0-9]/.test(pw))
                            return { level: 4, label: 'Strong', color: '#4ade80' };
        return              { level: 3, label: 'Good',   color: '#a07840' };
    };
    ...
    return (
        ...
        >
            ...
            />
            <div
                className="pointer-events-none absolute bottom-0 right-1/4 w-[300px] h-[300px] opacity-8 blur-[100px]"
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                >
                    ...
                    {/* ── Success state ── */}
                    {success ? (
                        <div className="relative z-10 flex flex-col items-center text-center py-8 space-y-4">
                            ...
                            <p className="text-sm" style={{ color: '#7a6a4a', fontFamily: 'Georgia, serif' }}>
                                Welcome to Bibliocraft. Your reading journey starts now.
                            </p>
                            <Link href="/login">
                                <button
                                    className="mt-4 px-8 py-3 rounded-xl text-sm font-semibold"
                                    style={{
                        ...
                        <form onSubmit={handleSubmit} className="relative z-10 space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    Photo URL{' '}
                                    <span style={{ color: '#3a3020', textTransform: 'none', letterSpacing: 0 }}>
                                        (optional)
                                    </span>
                                </label>
                                <div className="relative">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3 rounded-xl text-sm font-semibold tracking-wide mt-2"
                                style={{
                                    background: loading
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex-1 h-px" style={{ background: 'rgba(232,213,163,0.08)' }} />
